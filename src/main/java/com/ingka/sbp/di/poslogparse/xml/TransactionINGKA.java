...
public class TransactionINGKA {
	...
	public Date getBUS_DAY() {
		return BUS_DAY;
	}
	public void setBUS_DAY(Date bUS_DAY) {
		BUS_DAY = bUS_DAY;
	}
	...
	public int getTRA_SEQ_NO() {
		return TRA_SEQ_NO;
	}
	public void setTRA_SEQ_NO(int tRA_SEQ_NO) {
		TRA_SEQ_NO = tRA_SEQ_NO;
	}
	public Time getTRA_STA_DTM() {
		return TRA_STA_DTM;
	}
	public void setTRA_STA_DTM(Time tRA_STA_DTM) {
	...
	public DateTime getETL_INS_DTM() {
		return ETL_INS_DTM;
	}
	public void setETL_INS_DTM(DateTime eTL_INS_DTM) {
