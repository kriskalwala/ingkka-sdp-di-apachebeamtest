...
public class DataflowSBPDI17MAY {
	...
	public static void main(String[] args) {
		...
		dataflowPipeLineOptions.setJobName("StreamingIngestion17MAYEE");
	...
	//	PCollection<String>  pubsubmessage2 = pubsubmessage.apply("ReadFromText", TextIO.read().from(pubsubmessage.toString().toLowerCase());    // apply("ReadFromText",TextIO.read().from(pubsubmessage.toString().concat(" second step"))); 
		...
		bqrow.apply(BigQueryIO.writeTableRows().to("cpskk2021-03-1615568275864:smalltech.pubsubStream6").withCreateDisposition(BigQueryIO.Write.CreateDisposition.CREATE_NEVER)
