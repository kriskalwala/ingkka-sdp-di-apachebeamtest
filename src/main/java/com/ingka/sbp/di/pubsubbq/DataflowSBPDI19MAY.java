...
public class DataflowSBPDI19MAY {
	...
	public static void main(String[] args) {
		...
		dataflowPipeLineOptions.setJobName("StreamingIngestion20MAY");
		...
		PCollection<TableRow> bqrow2 =  pubsubmessage2.apply( ParDo.of(new ConvertStringBqB()) );
